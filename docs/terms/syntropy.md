...
see [[focus]] for the distribution syntropy measures · [[Bayesian Truth Serum]] for the per-neuron version · [[rewards]] for how syntropy growth becomes [[$CYB]] · [[tri-kernel]] for the convergence that produces $\phi^*$.
